...
export function MessageInput({ onSend, onTyping, disabled }: Props) {
  ...
  return (
    <div style={{ display: 'flex', gap: 8, padding: '0.75rem 1rem', borderTop: '1px solid #e5e5e5' }}>
      <textarea
        value={value}
        ...
        style={{
          ...
          border: '1px solid #ddd', resize: 'none', fontSize: 14,
      ...
      <button
        ...
        style={{
          padding: '0 1.25rem', borderRadius: 8, border: 'none',
